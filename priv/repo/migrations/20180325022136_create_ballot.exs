defmodule Votr.Repo.Migrations.CreateBallot do
  ...
  def change do
    create table(:ballot, comment: "An ballot definition") do
      ...
      add(:shuffle, :bool, size: 1, null: false, default: false, comment: "Candidates are presented in random order")
      add(:mutable, :bool, size: 1, null: false, default: false, comment: "Vote can be changed")
      add(:public, :bool, size: 1, null: false, default: true, comment: "Results are publicly available")
      add(:anonymous, :bool, size: 1, null: false, default: true, comment: "Votes are anonymous")
